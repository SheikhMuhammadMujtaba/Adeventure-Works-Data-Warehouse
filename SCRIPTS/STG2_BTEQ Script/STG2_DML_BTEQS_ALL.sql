...
INSERT INTO DB_STG2.Employee(BusinessEntityID, NationalIDNumber,LoginID,JobTitle,BirthDate, Gender,HireDate,VacationHours,SickLeaveHours)
SELECT DISTINCT  
...
INSERT INTO DB_STG2.PurchaseOrderDetail(PurchaseOrderID, PurchaseOrderDetailID,DueDate,ProductID, OrderQty,UnitPrice,LineTotal, ReceivedQty,RejectedQty,StockedQty)
SELECT DISTINCT
...
CASE WHEN ReceivedQty1 = 'NULL' THEN -1 ELSE ReceivedQty1 END AS ReceivedQty,
CASE WHEN RejectedQty2 = 'NULL' THEN -1 ELSE RejectedQty2 END AS RejectedQty,
...
CASE WHEN "Title" = 'NULL' THEN 'N/A' ELSE CAST("Title" AS CHAR(4)) END AS Title1,
...
SELECT DISTINCT
CASE WHEN a.BusinessEntityID1 = 'NULL' THEN -1 ELSE BusinessEntityID1 END AS BusinessEntityID,
CASE WHEN a.PhoneNumber = 'NULL' THEN -1 ELSE PhoneNumber END AS PhoneNumber,
CASE WHEN a.PhoneNumberTypeID1 IS NULL THEN -1 ELSE PhoneNumberTypeID1 END AS PhoneNumberTypeID
...
CASE WHEN "Class" = 'NULL' THEN 'N/A' ELSE "Class" END AS CLASS1,
...
CASE Name WHEN 'NULL' THEN 'N/A' ELSE Name END AS Name1
...
INSERT INTO DB_STG2.SalesOrderDetail
	...
	SELECT DISTINCT
	CASE WHEN BusinessEntityID1 = 'NULL' THEN -1 ELSE BusinessEntityID1 END AS BusinessEntityID,
	CASE WHEN SalesOrderID11 = 'NULL' THEN -1 ELSE SalesOrderID11 END AS SalesOrderID1,
	CASE WHEN SalesOrderDetailID11 = 'NULL' THEN -1 ELSE SalesOrderDetailID11 END AS SalesOrderDetailID,
	CASE WHEN CarrierTrackingNumber11 = 'NULL' THEN 'N/A' ELSE CarrierTrackingNumber11 END AS CarrierTrackingNumber,
	CASE WHEN OrderQty11 = 'NULL' THEN -1 ELSE OrderQty11 END AS OrderQty,
	CASE WHEN ProductID11 = 'NULL' THEN -1 ELSE ProductID11 END AS ProductID,
	CASE WHEN SpecialOfferID11 = 'NULL' THEN -1 ELSE SpecialOfferID11 END AS SpecialOfferID,
	CASE WHEN  UnitPrice11 = 'NULL' THEN -1 ELSE  CAST(UnitPrice11 AS DECIMAL(10,2)) END AS UnitPrice,
	CASE WHEN UnitPriceDiscount11 = 'NULL' THEN -1 ELSE  CAST(UnitPriceDiscount11 AS DECIMAL(6,2)) END AS UnitPriceDiscount,
	CASE WHEN  LineTotal1 = 'NULL' THEN -1 ELSE  CAST(LineTotal1 AS DECIMAL(10,2)) END AS LineTotal
...
CASE WHEN BusinessEntityID1 = 'NULL' THEN -1 ELSE BusinessEntityID1 END AS BusinessEntityID,
CASE WHEN SalesOrderID11 = 'NULL' THEN -1 ELSE SalesOrderID11 END AS SalesOrderID1,
CASE WHEN ShipMethodID1 = 'NULL' THEN -1 ELSE ShipMethodID1 END AS ShipMethodID,
CASE WHEN SalesPersonID21 = 'NULL' THEN -1 ELSE SalesPersonID21 END AS SalesPersonID,
CASE WHEN RevisionNumber11 = 'NULL' THEN -1 ELSE RevisionNumber11 END AS RevisionNumber,
CASE WHEN OrderDate1 IS NULL THEN CAST('01/01/1900' AS DATE FORMAT 'MM/DD/YYYY') ELSE CAST(SUBSTR(OrderDate1,1,10) AS DATE FORMAT 'MM/DD/YYYY') END AS OrderDate,
CASE WHEN DueDate1 = 'NULL' THEN CAST('01/01/1900' AS DATE FORMAT 'MM/DD/YYYY') ELSE CAST(SUBSTR(DueDate1,1,10) AS DATE FORMAT 'MM/DD/YYYY') END AS DueDate,
CASE WHEN ShipDate1 = 'NULL' THEN CAST('01/01/1900' AS DATE FORMAT 'MM/DD/YYYY') ELSE CAST(SUBSTR(ShipDate1,1,10) AS DATE FORMAT 'MM/DD/YYYY') END AS ShipDate,
CASE WHEN Status1 = 'NULL' THEN -1 ELSE CAST(Status1 AS BYTEINT) END AS Status,
CASE WHEN OnlineOrderFlag1 = 'NULL' THEN -1 ELSE CAST(OnlineOrderFlag1 AS BYTEINT) END AS OnlineOrderFlag,
CASE WHEN SalesOrderNumber11 IS NULL THEN 'N/A' ELSE SalesOrderNumber11 END AS SalesOrderNumber,
CASE WHEN PurchaseOrderNumber11 IS NULL THEN 'N/A' ELSE PurchaseOrderNumber11 END AS PurchaseOrderNumber,
CASE WHEN AccountNumber1= 'NULL' THEN 'N/A' ELSE AccountNumber1 END AS AccountNumber,
CASE WHEN TerritoryID1 = 'NULL' THEN -1 ELSE TerritoryID1 END AS TerritoryID1,
CASE WHEN BillToAddressID1 = 'NULL' THEN -1 ELSE BillToAddressID1 END AS BillToAddressID,
CASE WHEN ShipToAddressID1 = 'NULL' THEN -1 ELSE ShipToAddressID1 END AS ShipToAddressID,
CASE WHEN CreditCardID1= 'NULL' THEN -1 ELSE CreditCardID1 END AS CreditCardID,
CASE WHEN CreditCardApprovalCode1 IS NULL THEN 'N/A' ELSE CreditCardApprovalCode1 END AS CreditCardApprovalCode,
CASE WHEN CurrencyRateID1 = 'NULL' THEN -1 ELSE CurrencyRateID1 END AS CurrencyRateID2,
CASE WHEN  SubTotal1 = 'NULL' THEN -1 ELSE  CAST(SubTotal1 AS DECIMAL(10,2)) END AS SubTotal,
CASE WHEN  TaxAmt1 = 'NULL' THEN -1 ELSE  CAST(TaxAmt1 AS DECIMAL(10,2)) END AS TaxAmt,
CASE WHEN  Freight1 = 'NULL' THEN -1 ELSE  CAST(Freight1 AS DECIMAL(10,2)) END AS Freight,
CASE WHEN  TotalDue1 = 'NULL' THEN -1 ELSE  CAST(TotalDue1 AS DECIMAL(10,2)) END AS TotalDue
FROM DB_STG1.Sales_2;
...
FROM DB_STG1.Sales_Tax_Rate_Sales;
...
SELECT DISTINCT 
    CASE WHEN BusinessEntityID IS NULL THEN -1 ELSE BusinessEntityID END AS BusinessEntityID,
    CASE WHEN SalesPersonID IS NULL THEN -1 ELSE SalesPersonID END AS SalesPersonID,
    CASE WHEN Name IS NULL THEN 'N/A' ELSE Name END AS Name1,
    CASE WHEN DEMOGRAPHICS IS NULL THEN 'N/A' ELSE DEMOGRAPHICS END AS DEMOGRAPHICS1
